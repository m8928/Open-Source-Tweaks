...
/* DONE: unsigned __int8 __cdecl +[AppJailBrokenChecker isAppJailbroken](AppJailBrokenChecker_meta *self, SEL a2) */
/* DONE: bool __cdecl -[ANSMetadata computeIsJailbroken](ANSMetadata *self, SEL a2) */
/* DONE: bool __cdecl -[InitViewController isJailbreak](InitViewController *self, SEL a2) */
/* DONE: bool __cdecl +[DocumentPath isJailbroken](DocumentPath_meta *self, SEL a2) */
/* FAKE: Always return 0, bool __cdecl +[SFAntiPiracy isTheDeviceJailbroken](SFAntiPiracy_meta *self, SEL a2) */
